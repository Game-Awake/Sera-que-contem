class Main extends Phaser.Scene
{
    ...
    create ()
    {
      ...
      for(let i=0;i<this.teams*2;i+=2) {
        ...
        let text = "Team " + id;
        this.board.teams[id].name = this.add.text(80,120+i*40,text,style);
        this.board.teams[id].name.setOrigin(0.5);
        this.board.teams[id].name.setInteractive();
        this.board.teams[id].score = this.add.text(80,120+(i+1)*40,"0",style);
      ...
      this.questionLabel = this.add.text(150,10,"",style);
      this.board.answers = [];
    ...
    showQuestion() {
      ...
      for(let j in this.question.answers) {
        ...
        text = "";
        this.board.answers[i].optionValue = new Option(300+x*350,150+y*100,150,80,
          0x0000ff,2,0xffffff,
          text, style,
          () => {}, this);
        this.board.answers[i].optionPercentage = new Option(450+x*350,150+y*100,100,80,
          0x0000ff,2,0xffffff,
          text, style,
          () => {}, this);
        y++;
